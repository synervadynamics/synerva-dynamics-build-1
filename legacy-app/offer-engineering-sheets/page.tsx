...
export default function OfferEngineeringSheetsPage() {
  const { hero, overview, architecture, process, outcomes, faq, cta } = copyOfferEngineeringSheets;
    ...
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      ...
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        ...
        <FadeIn className="grid gap-6 sm:grid-cols-2">
          <VideoPlaceholder label="Feature sequencing storyboard" ratio="aspect-[4/5]" />
          <VideoPlaceholder label="Tiering logic preview" ratio="aspect-[4/5]" />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Each sheet keeps value honest and sequencing disciplined so every offer feels inevitable—not forced.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Define the outcome, assemble proof, stage the narrative, and ship with instrumentation—every launch accountable to lift.
          </p>
        </FadeIn>
