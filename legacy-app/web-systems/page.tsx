...
export default function WebSystemsPage() {
  const { hero, overview, modules, process, outcomes, faq, cta } = copyWebSystems;
    ...
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      ...
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        ...
        <FadeIn className="grid gap-6 sm:grid-cols-2">
          <VideoPlaceholder label="Sitemap strategy board" ratio="aspect-[4/5]" />
          <VideoPlaceholder label="Wireframe walkthrough" ratio="aspect-[4/5]" />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Every deliverable pairs structure, proof, and instrumentation so the site ships fast and remains measurable.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            The build cadence keeps proof, performance, and rollback discipline connected from first map to final launch.
          </p>
        </FadeIn>
