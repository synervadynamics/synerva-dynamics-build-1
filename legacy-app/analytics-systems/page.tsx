...
export default function AnalyticsSystemsPage() {
  const { hero, overview, modules, process, outcomes, faq, cta } = copyAnalyticsSystems;
    ...
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      ...
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        ...
        <FadeIn className="grid gap-6 sm:grid-cols-2">
          <VideoPlaceholder label="Attribution model diagram" ratio="aspect-[4/5]" />
          <VideoPlaceholder label="Reporting cadence planner" ratio="aspect-[4/5]" />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Each module connects inputs to outcomes so leaders see cause, effect, and next move on one canvas.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            The loop keeps tagging honest, dashboards accurate, and decisions tied to evidence—continually refining the system.
          </p>
        </FadeIn>
