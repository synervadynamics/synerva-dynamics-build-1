...
export default function ContentSystemsWorkbookPage() {
  const { hero, overview, architecture, process, outcomes, faq, cta } = copyContentSystemsWorkbook;
    ...
    <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24 space-y-24">
      ...
      <section className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        ...
        <FadeIn className="grid gap-6 sm:grid-cols-2">
          <VideoPlaceholder label="Editorial matrix preview" ratio="aspect-[4/5]" />
          <VideoPlaceholder label="Cadence builder storyboard" ratio="aspect-[4/5]" />
        </FadeIn>
      </section>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Every worksheet and template keeps campaigns aligned to voice, proof, and measurable lift—no guesswork, no wasted output.
          </p>
        </FadeIn>
      ...
      <section className="space-y-8">
        <FadeIn>
          ...
          <p className="mt-3 max-w-3xl text-sm text-mute sm:text-base">
            Plan, schedule, produce, publish, and optimize—each stage documented so teams can repeat success and retire what doesn’t lift.
          </p>
        </FadeIn>
